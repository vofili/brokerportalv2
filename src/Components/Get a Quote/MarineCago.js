...
export default function MarineCago() {
  ...
  const cover = [
    { label: "Clause A", value: "Clause A" },
    { label: "Clause B", value: "Clause B" },
  ];
  const natureOfGoods = [
    { label: "Industrial Machine", value: "Industrial Machine" },
      ...
      <div className=" lg:block mobile:hidden pl-[22rem]  h-fit pb-[50px]   w-full">
        ...
        <div className="mt-[10px]">
          <h3 className="text-[16px] font-medium text-[#808285] opacicty-[1] tracking-[0.26px] ">
            Dashboard <Link to="/marineinsurance">/ Marine Cargo Insurance /</Link>
        ...
        <div className=" mt-[54px] w-[75%]">
          <div className="text-left">
            ...
            <p className="text-[18px] font-normal mt-[8px] text-[#1A1A1A] ">Fill in Marine Cargo information</p>
          </div>
        </div>
        ...
        <div className=" w-[95%] h-fit pb-[40px] pl-[25px] pt-[37px] rounded-[8px] mt-[34px] bg-white ">
          ...
          <form className=" flex flex-wrap items-center gap-[30px] mt-6 w-[95%] ">
            ...
            <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pt-[5px] pb-[10px]  rounded w-[350px] flex flex-col justify-between h-[60px] ">
              <label htmlFor="">Vessel Name</label>
            ...
            <SelectInput placeholder={`Cover`} label={cover} />
            <SelectInput placeholder={`Nature of Goods`} label={natureOfGoods} />
            <SelectInput placeholder={`Category`} label={category} />
            <SelectInput placeholder={`Transport Mode`} label={transportMode} />
            <SelectInput placeholder={`Originating Country`} label={country} />
            <SelectInput placeholder={`Destination Country`} label={country} />

            <SelectInput placeholder={`Interested Party`} label={interestedParty} />
            <textarea placeholder="Description of Goods" className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pt-[5px] pb-[10px]  rounded w-[350px] flex flex-col justify-between h-[100px] "></textarea>
          </form>
          ...
          <form className=" flex flex-wrap items-center gap-[30px] mt-6 w-[95%] ">
            ...
            <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pt-[5px] pb-[10px]  rounded w-[250px] flex flex-col justify-between h-[60px] ">
              <label htmlFor="">Business Address (Street)</label>
              <input className=" outline-none w-full h-2/4 bg-none" type="number" />
            </div>
            <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pt-[5px] pb-[10px]  rounded w-[250px] flex flex-col justify-between h-[60px] ">
              <label htmlFor="">Business Address (Line 2)</label>
              <input className=" outline-none w-full h-2/4 bg-none" type="number" />
            </div>
            <GetQuoteSelect placeholder={`City`} label={city} />
            <GetQuoteSelect placeholder={`City`} label={city} />
            ...
            <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pt-[5px] pb-[10px]  rounded w-[250px] flex flex-col justify-between h-[60px] ">
              <label htmlFor="">RC Nuumber</label>
              <input className=" outline-none w-full h-2/4 bg-none" type="number" />
            </div>
        ...
        <div className=" w-[95%] h-fit pb-[40px] pl-[25px] pt-[37px] rounded-[8px] mt-[34px] bg-white ">
          ...
          {/* Toggle Button */}
          <label htmlFor="toggle" className="flex gap-3 mt-[40px] items-center cursor-pointer">
          ...
          <form className="  flex flex-wrap items-center gap-[30px] mt-[40px] w-[95%] ">
            {isChecked ? (
              <>
                <GetQuoteSelect placeholder={`ID Type`} label={id} />
                <label className="text-[#cccccc]" htmlFor="">
                  KYC Document
              ...
              <>
                ...
                <GetQuoteSelect placeholder={`ID`} label={id} />
