...
function MotorInsurancePrivate() {
      ...
      <div className=" lg:block mobile:hidden pl-[22rem]  h-fit pb-[50px]   w-full">
        ...
        <div className="mt-[10px]">
          <h3 className="text-[16px] font-medium text-[#808285] opacicty-[1] tracking-[0.26px] ">
            Dashboard <Link to="/motorinsurance">/ Motor Insurance/</Link>
            <span className="text-[20px] text-[#009677] tracking-[0.32px] ">Get Quote</span>
          </h3>
        </div>
        <div className=" mt-[54px] w-[75%]">
          <div className="text-left">
            <h3 className="text-[28px] font-[600] text-[#1a1a1a] tracking-[0.56px]  ">Submit Quote</h3>

            <p className="text-[18px] font-normal mt-[8px] text-[#1A1A1A] ">Fill in motor vehicle information</p>
          </div>
        </div>
        ...
        <div className=" w-[95%] h-fit pb-[40px] pl-[25px] pt-[37px] rounded-[8px] mt-[34px] bg-white ">
          {/* Toggle Button */}
          <label htmlFor="toggle" className="flex gap-3 mt- items-center cursor-pointer">
          ...
          {isChecked ? (
            <>
              <div className=" mt-[40px] w-[90%] border-b-[1px] border-b-[#E5E7ED] flex justify-start pb-[20px] pl-[20px] items-center ">
              ...
              <form className=" flex flex-wrap items-center gap-[30px] mt-6 w-[95%] ">
                ...
                <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pt-[5px] pb-[10px]  rounded w-[250px] flex flex-col justify-between h-[60px] ">
                  <label htmlFor="">RCC Number</label>
            ...
            <>
              ...
              <form className=" flex flex-wrap items-center gap-[30px] mt-6 w-[95%] ">
                ...
                <SelectInput placeholder={`City/Town`} label={city} />
                <SelectInput placeholder={`Choose State`} label={state} />
              ...
              <label htmlFor="info" className="flex gap-3 mt-[40px] items-center cursor-pointer">
                <div className="relative ">
                  {/* Hidden input */}
                  <input type="checkbox" id="info" className="sr-only" checked={excess} onChange={handleExcess} />
                  {/* Visual switch */}
                  <div className={`block  w-10 h-6 rounded-full ${excess ? "bg-[#9CCD65]" : "bg-[#EEEEEE]"}`} />
                  {/* Switch ball */}
                  <div className={`absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition-transform transform ${excess ? "translate-x-full " : "translate-x-0 "}`} />
                </div>{" "}
                Excess Buy Back
              </label>
              <form className=" flex flex-wrap items-center gap-[30px] mt-6 w-[95%] ">
                ...
                <SelectInput placeholder={`Usage Type`} label={usage} />
                <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pt-[5px] pb-[10px]  rounded w-[350px] flex flex-col justify-between h-[60px] ">
                  <label htmlFor="">Vehicle Registration No</label>
                  <input className=" outline-none w-full h-2/4 bg-none" type="number" />
                </div>
                <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pt-[5px] pb-[10px]  rounded w-[350px] flex flex-col justify-between h-[60px] ">
                  <label htmlFor="">Chassis No/VN</label>
                  <input className=" outline-none w-full h-2/4 bg-none" type="number" />
                </div>
                <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pt-[5px] pb-[10px]  rounded w-[350px] flex flex-col justify-between h-[60px] ">
                ...
                <SelectInput placeholder={`Vehicle Year`} label={vehicleYear} />
                <SelectInput placeholder={`Vehicle Make`} label={vehicleYear} />
                <SelectInput placeholder={`Choose Model`} label={vehicleYear} />
                <label className="text-[#cccccc]" htmlFor="">
                  Picture of Vehicle (Front) *
                  <div className="w-[350px] border-[0.5px] rounded h-[52px] flex justify-between items-center  border-solid border-[#9C9898]  mt-[10px]">
                    <div className="bg-[#F6F7F9] border-r-[#9C9898] flex justify-center items-center rounded-l h-[49px] border-r-[0.5px] w-[70px] ">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_16_204)">
              ...
              <div className=" mt-[40px] w-[90%] border-b-[1px] border-b-[#E5E7ED] flex justify-between  pb-[20px] pl-[20px] items-center ">
                <div className="  text-[#171717] text-[20px] font-semibold ">
                  <h3>KYC Information</h3>
                </div>
                <h4 className="text-[#cccccc]"> Upload (File size 500kb)</h4>
              </div>
              <form className=" flex flex-wrap items-center gap-[30px] mt-6 w-[95%] ">
                <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pt-[5px] pb-[10px]  rounded w-[350px] flex flex-col justify-between h-[60px] ">
                ...
                <SelectInput placeholder={`ID Type`} label={idType} />
                <div className=" px-3 border-solid border-[0.5px] border-[#9C9898] text-[#cccccc] pt-[5px] pb-[10px]  rounded w-[250px] flex flex-col justify-between h-[60px] ">
                  <label htmlFor="">First Name</label>
                  <input className=" outline-none w-full h-2/4 bg-none" type="text" />
                </div>{" "}
...
export default MotorInsurancePrivate;
