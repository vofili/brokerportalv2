      ...
      <div className=" mobile:hidden lg:block pl-[22rem] h-fit pb-[50px]   w-full">
        ...
        <div className="w-[90%] mt-[28px]">
          ...
          <div className=" w-full p-[30px] bg-white h-fit ">
            <form className=" flex flex-wrap items-center gap-[30px] ">
              <section className="">
                ...
                <div className=" mt-3">
                  <a href={form} className="text-[14px]" download>
              ...
              <section className="">
                ...
                <div className="h-[40px]">{/* intentional break */}</div>
              </section>

              <section>
                <div className="lg:h-[30px] 3xl:h-[0px]">{/* intentional */}</div>
